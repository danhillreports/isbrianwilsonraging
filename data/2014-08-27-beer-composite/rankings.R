...
# filter relievers with more than 20 innings
data <- subset(data, IP > 20, select=-playerid)
...
# assigns 1-8 ranking to each reliever for a given stat
# 8 is best ranking, 1 is worst
...
data$Overall <- round((data$Overall / 88) * 100, 1)
